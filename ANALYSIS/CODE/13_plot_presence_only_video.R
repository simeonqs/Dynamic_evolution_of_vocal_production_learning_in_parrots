...
path_pdf = 'ANALYSIS/RESULTS/results presence mimicry - only video.pdf'
path_models_presence = 'ANALYSIS/RESULTS/models_presence_video_only.RData'
path_pdf_phylo = 'ANALYSIS/RESULTS/results phylogenetic signal - only video.pdf'
